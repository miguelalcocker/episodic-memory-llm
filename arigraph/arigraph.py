...
def create_arigraph_agent(openai_api_key: str, main_goal: str) -> AriadneAgent:
...
def run_arigraph_evaluation(openai_api_key: str) -> Dict[str, Any]:
...
def demonstrate_arigraph_memory(openai_api_key: str):
    """Demonstrate AriGraph memory construction and retrieval"""
    # Create agent
    agent = create_arigraph_agent(openai_api_key, "Explore and understand the environment")
...
if __name__ == "__main__":
    ...
    # demonstrate_arigraph_memory(API_KEY)
    
    # Run evaluation
    # results = run_arigraph_evaluation(API_KEY)
